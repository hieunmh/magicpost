<template>
  <MainLayout>
    <div class="mt-6">
      ...
      >
        <div
          class="md:w-[1100px] w-full flex p-2 sm:p-6 rounded-xl shadow-lg border-[1px]"
        >
          <div
          ...
          >
            <div
              ...
              v-for="head in userStore.allTransactionEmployee"
              @click="showHeadDetail(head)"
            >
      ...
      >
        ...
        >
          ...
          >
            <div
              class="flex flex-col p-2 sm:p-6 rounded-xl shadow-lg border-[1px] text-gray-500 text-xs sm:text-sm md:text-lg font-semibold"
              v-for="p in packageStore.allPackage"
              @click="showPackage(p)"
            >
              <div class="grid grid-cols-12 h-8 items-center text-center">
                <div class="col-span-4">ID:</div>
